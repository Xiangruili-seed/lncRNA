...
c2c12<-as.data.frame(c2c12[c2c12!=0])
cortex<-as.data.frame(cortex[cortex!=0])
forelimb_11<-as.data.frame(forelimb_11[forelimb_11!=0])
hippocampus<-as.data.frame(hippocampus[hippocampus!=0])
forelimb_13<-as.data.frame(forelimb_13[forelimb_13!=0])
...
pdf("/data/tusers/lixiangr/lncRNA/mouse/read_distance_none_zero.pdf")
